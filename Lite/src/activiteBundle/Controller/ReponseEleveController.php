...
class ReponseEleveController extends Controller
{
    public function ListQuizAction(Request $request)
    {
        ...
        $reponseEleve->setEleve( $em->getRepository('ScolariteBundle:Eleve')->find('1'));
    ...
    public function QuizResultPdfAction(Request $request)
    {
        ...
        $fileName = "result-".$reponseEleve->getEleve()->getNom()." ".$reponseEleve->getEleve()->getPrenom()." ".$date->format("yy-M-d Hms  ").".pdf" ;
