 ...
 */
class Reponse extends \activiteBundle\Entity\Reponse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'activiteBundle\\Entity\\Reponse' . "\0" . 'id', '' . "\0" . 'activiteBundle\\Entity\\Reponse' . "\0" . 'valeur', '' . "\0" . 'activiteBundle\\Entity\\Reponse' . "\0" . 'reponse', '' . "\0" . 'activiteBundle\\Entity\\Reponse' . "\0" . 'question'];
        }
