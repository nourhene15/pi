...
class __TwigTemplate_f0ca97c493e7747a7ddae3be277f088556af34ea3511b681fb4415c8f12c4f15 extends \Twig\Template
{
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 18
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("reservation_show", ["id" => $this->getAttribute($context["reservation"], "id", [])]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["reservation"], "id", []), "html", null, true);
            echo "</a></td>
                <td>";
            // line 19
            if ($this->getAttribute($context["reservation"], "date", [])) {
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["reservation"], "date", []), "Y-m-d H:i:s"), "html", null, true);
            }
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, $this->getAttribute($context["reservation"], "duree", []), "html", null, true);
            echo "</td>
                <td>
                    <ul>
                        <li>
            ...
            echo "\">show</a>
                        ...
                        <li>
                            <a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("reservation_edit", ["id" => $this->getAttribute($context["reservation"], "id", [])]), "html", null, true);
            echo "\">edit</a>
                        </li>
                    </ul>
                </td>
...
";
    ...
    {
        return array (  125 => 38,  118 => 33,  106 => 27,  100 => 24,  93 => 20,  87 => 19,  81 => 18,  78 => 17,  74 => 16,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{% endblock %}
", "reservation/index.html.twig", "C:\\xampp\\htdocs\\Lite\\app\\Resources\\views\\reservation\\index.html.twig");
    }
}
