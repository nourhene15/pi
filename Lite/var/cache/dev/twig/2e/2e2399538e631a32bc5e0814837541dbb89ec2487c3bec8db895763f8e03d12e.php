...
class __TwigTemplate_dcec4fae77a4f13351c44ad8bdd82a97c6baa4b20243829cd3e6cba3ebab7947 extends \Twig\Template
{
    ...
    <div class=\"contact-us container\">
        ...
        echo "
                    <label for=\"name\" class=\"nameLabel\">Date : </label>
        ...
        echo "
                    <label for=\"email\" class=\"emailLabel\">Duree (en jour): </label>
                ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "duree", []), 'widget', ["attr" => ["max" => "15", "max" => "1"]]);
        echo "
...
";
    ...
    {
        return array (  84 => 17,  78 => 14,  73 => 12,  67 => 9,  60 => 4,  51 => 3,  29 => 1,);
    }
        ...
        <div class=\"row\">
            <div class=\"contact-form span12\">
                ...
                {{ form_widget(form.date) }}
                    <label for=\"email\" class=\"emailLabel\">Duree (en jour): </label>
                {{ form_widget(form.duree,{'attr':{'max':'15','max':'1'}}) }}
...
", ":reservation:new.html.twig", "C:\\xampp\\htdocs\\Lite\\app/Resources\\views/reservation/new.html.twig");
    }
}
