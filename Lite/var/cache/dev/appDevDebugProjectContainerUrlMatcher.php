...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/add')) {
            // add_cours
            if ('/addcours' === $pathinfo) {
                return array (  '_controller' => 'activiteBundle\\Controller\\CoursController::AddCoursAction',  '_route' => 'add_cours',);
            }

            // addQuestion
            if ('/addQuestion' === $pathinfo) {
                return array (  '_controller' => 'activiteBundle\\Controller\\QuestionsController::addQuestionAction',  '_route' => 'addQuestion',);
            }

            // add_reponse
            if (0 === strpos($pathinfo, '/addReponse') && preg_match('#^/addReponse/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, ['_route' => 'add_reponse']), array (  '_controller' => 'activiteBundle\\Controller\\ReponseController::addReponseAction',));
            }
        ...
        elseif (0 === strpos($pathinfo, '/l')) {
            if (0 === strpos($pathinfo, '/li')) {
                // list_cours
                if ('/listcours' === $pathinfo) {
                    return array (  '_controller' => 'activiteBundle\\Controller\\CoursController::ListCoursAction',  '_route' => 'list_cours',);
                }

                // listeQuestions
                if ('/listeQuestions' === $pathinfo) {
                    return array (  '_controller' => 'activiteBundle\\Controller\\QuestionsController::listeQuestionsAction',  '_route' => 'listeQuestions',);
                }
        ...
        // update_cours
        if (0 === strpos($pathinfo, '/updatecour') && preg_match('#^/updatecour/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'update_cours']), array (  '_controller' => 'activiteBundle\\Controller\\CoursController::UpdateCoursAction',));
        }

        // update_questions
        if (0 === strpos($pathinfo, '/updateQuestions') && preg_match('#^/updateQuestions/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'update_questions']), array (  '_controller' => 'activiteBundle\\Controller\\QuestionsController::updateQuestionsAction',));
        }

        // delete_cours
        if (0 === strpos($pathinfo, '/deletecour') && preg_match('#^/deletecour/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'delete_cours']), array (  '_controller' => 'activiteBundle\\Controller\\CoursController::DeleteCoursAction',));
        }

        // delete_questions
        if (0 === strpos($pathinfo, '/deletequestions') && preg_match('#^/deletequestions/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, ['_route' => 'delete_questions']), array (  '_controller' => 'activiteBundle\\Controller\\QuestionsController::DeleteQuestionsAction',));
        }

        // listcoursetquiz_cours
        if ('/ListCoursEtQuiz' === $pathinfo) {
            return array (  '_controller' => 'activiteBundle\\Controller\\CoursController::ListCoursEtQuizAction',  '_route' => 'listcoursetquiz_cours',);
        }

        // listcoursetquiz
        if ('/ListQuiz' === $pathinfo) {
            return array (  '_controller' => 'activiteBundle\\Controller\\ReponseEleveController::ListQuizAction',  '_route' => 'listcoursetquiz',);
        }

        if (0 === strpos($pathinfo, '/QuizResult')) {
            // quizresult
            if ('/QuizResult' === $pathinfo) {
                return array (  '_controller' => 'activiteBundle\\Controller\\ReponseEleveController::QuizResultAction',  '_route' => 'quizresult',);
            }

            // quizresultpdf
            if ('/QuizResultPdf' === $pathinfo) {
                return array (  '_controller' => 'activiteBundle\\Controller\\ReponseEleveController::QuizResultPdfAction',  '_route' => 'quizresultpdf',);
            }
