...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\activiteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ScolariteBundle\\Entity')]);
...
$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'activiteBundle' => 'activiteBundle\\Entity', 'ScolariteBundle' => 'ScolariteBundle\\Entity']);
